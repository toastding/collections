...
# https://newsapi.org/v2/everything?q=Apple&from=2021-07-19&sortBy=popularity&apiKey=API_KEY
#
#
# news_params = {
#     'q': COMPANY_NAME,
...
#
# TODO 7. - Use Python slice operator to create a list that contains the first 3 articles. Hint: https://stackoverflow
#  .com/questions/509211/understanding-slice-notation

# stock_news = [news_data["articles"][:3]]
#
#
